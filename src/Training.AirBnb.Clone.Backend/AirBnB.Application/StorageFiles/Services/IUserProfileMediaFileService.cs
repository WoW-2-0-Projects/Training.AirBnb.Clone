...
/// </summary>
public interface IUserProfileMediaFileService
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="uploadFileInfo">The UploadFileInfo object to create UserProfileMediaFile from.</param>
    ...
    ValueTask<UserProfileMediaFile> CreateAsync(UploadFileInfoDto uploadFileInfo, bool saveChanges = true,
