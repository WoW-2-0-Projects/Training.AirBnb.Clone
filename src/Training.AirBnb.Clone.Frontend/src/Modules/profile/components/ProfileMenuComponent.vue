<template>
  <div tabindex="0" ref="container" @focusout="onClose" class="absolute top-[70px] h-auto w-[220px] z-auto rounded-xl theme-bg-primary -mr-[20px] theme-shadow drop-shadow-lg flex flex-col justify-between items-start theme-border theme-shadow">
    ...
    <button class="text-left theme-text-primary theme-hover-button font-sans font-light pb-4 pl-3 pt-3 w-full theme-hover-shadow">
      <a href="http://localhost:5173/">Log in</a>
    </button>

    <div class="h-[1px] flex top-[150px] w-full theme-border"/>

    <button class="text-left theme-text-primary theme-hover-button font-sans font-light p-3 w-full theme-hover-shadow">
